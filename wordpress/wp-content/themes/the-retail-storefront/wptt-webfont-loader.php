...
if ( ! class_exists( 'The_Retail_Storefront_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class The_Retail_Storefront_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'the_retail_storefront_wptt_get_webfont_styles' ) ) {
	/**
	 ...
	 */
	function the_retail_storefront_wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new The_Retail_Storefront_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_styles();
	}
}

if ( ! function_exists( 'the_retail_storefront_wptt_get_webfont_url' ) ) {
	/**
	 ...
	 * @return string Returns the CSS.
	 */
	function the_retail_storefront_wptt_get_webfont_url( $url, $format = 'woff2' ) {
		$font = new The_Retail_Storefront_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_url();
	}
