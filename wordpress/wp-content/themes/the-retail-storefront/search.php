...
<section class="blog-area inarea-blog-2-column-area three">
	<div class="container">
		<div class="row">
			<?php 
                $the_retail_storefront_search_result_sidebar_setting = get_theme_mod('the_retail_storefront_search_result_sidebar_setting','1');
                $the_retail_storefront_sidebar_position = get_theme_mod('the_retail_storefront_sidebar_position', 'right');
                $the_retail_storefront_content_class = ($the_retail_storefront_search_result_sidebar_setting == '') ? 'col-lg-12' : 'col-lg-8';
			...
			<?php if( $the_retail_storefront_search_result_sidebar_setting != '') { ?> 
                <?php get_sidebar(); ?>
            <?php } ?>
		</div>
	</div>
