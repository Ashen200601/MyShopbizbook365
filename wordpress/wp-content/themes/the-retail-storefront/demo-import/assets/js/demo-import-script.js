...
jQuery(document).ready(function(){
    ...
    jQuery('#the-retail-storefront-demo-setup-guid .the-retail-storefront-setup-menu').attr("checked","checked");

    jQuery('#the-retail-storefront-setup-menu').click(function(){
        jQuery('#the-retail-storefront-demo-setup-guid .the-retail-storefront-setup-menu').css("display","block");
        jQuery('#the-retail-storefront-demo-setup-guid .the-retail-storefront-setup-contact').css("display","none");
        jQuery('#the-retail-storefront-demo-setup-guid .the-retail-storefront-setup-widget').css("display","none");
        jQuery('#the-retail-storefront-demo-setup-guid .the-retail-storefront-setup-social-icon').css("display","none");
    });

    jQuery('#the-retail-storefront-setup-contact').click(function(){
        jQuery('#the-retail-storefront-demo-setup-guid .the-retail-storefront-setup-menu').css("display","none");
        jQuery('#the-retail-storefront-demo-setup-guid .the-retail-storefront-setup-contact').css("display","block");
        jQuery('#the-retail-storefront-demo-setup-guid .the-retail-storefront-setup-widget').css("display","none");
        jQuery('#the-retail-storefront-demo-setup-guid .the-retail-storefront-setup-social-icon').css("display","none");
    });

    jQuery('#the-retail-storefront-setup-widget').click(function(){
        jQuery('#the-retail-storefront-demo-setup-guid .the-retail-storefront-setup-menu').css("display","none");
        jQuery('#the-retail-storefront-demo-setup-guid .the-retail-storefront-setup-contact').css("display","none");
        jQuery('#the-retail-storefront-demo-setup-guid .the-retail-storefront-setup-widget').css("display","block");
        jQuery('#the-retail-storefront-demo-setup-guid .the-retail-storefront-setup-social-icon').css("display","none");
    });

    jQuery('#the-retail-storefront-setup-social').click(function(){
        jQuery('#the-retail-storefront-demo-setup-guid .the-retail-storefront-setup-menu').css("display","none");
        jQuery('#the-retail-storefront-demo-setup-guid .the-retail-storefront-setup-contact').css("display","none");
        jQuery('#the-retail-storefront-demo-setup-guid .the-retail-storefront-setup-widget').css("display","none");
        jQuery('#the-retail-storefront-demo-setup-guid .the-retail-storefront-setup-social-icon').css("display","block");
    });
});